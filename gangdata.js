// gangdata.js
// Données gangs + membres. Si xp/karas manquent, gang.html tentera de les trouver via data.js.
...
const gangsData = [
...

  {
    ...
    rang: "—",
    roleLabel: "Élite",
    roleValue: "x934, Wawan, Joqueur, nadal51",
    recrutement: "—",
    trophees: "—",
    kara: null,
    members: [
...
{ nom: "Claud3", xp: 82, karas: 11, avatar: "avatar/150.jpg" },
...

  {
    ...
    trophees: "—",
    kara: null,
    // 12 membres, 4xp + 4kara chacun, avatars selon couleur
    members: [
      // bleus -> 123.jpg (ex)
