...
const joueurs = [
  // ===== 23 joueurs NV100 =====
  {
    ...
    modes:{
      ...
      "200k":{ jours:70, atteint_le:"27-05-2026", rang:"-", xp:200000, pauses_total:{nb:0, mois:0, jours:0}, pauses_detail:[] },
      "300k": { jours:76, atteint_le:"11-08-2026", rang:"", xp:300000, pauses_total:{nb:0, mois:0, jours:0}, pauses_detail:[] }
    }
  },
  {
  ...
  },
  {
    ...
    modes:{
      nv100:{ jours:48, atteint_le:"30-03-2026", rang:"-", xp:49500, pauses_total:{nb:0, mois:0, jours:0}, pauses_detail:[] }
    }
  },
  {
  ...
  modes:{
    ...
    "900k": { jours:141, atteint_le:"18-06-2026", rang:"—", xp:900000, pauses_total:{nb:0, mois:0, jours:0}, pauses_detail:[] },
  }
},
  {
  ...
  modes:{
    ...
    "1m3": { jours:null, atteint_le:"", rang:"—", xp:1300000, pauses_total:{nb:2, mois:3, jours:94}, pauses_detail:[ 
      {xp:1225000, periode:"01/02/2026 -> 02/04/2026", mois:2, jours:61}, 
      {xp:1273820, periode:"01/08/2026 -> 03/09/2026", mois:1, jours:33} ] }
  ...
  },
  {
    ...
    modes:{
      ...
      "200k":{ jours: 667, atteint_le:"09-06-2026", rang:"", xp:200000, pauses_total:{nb:2, mois:11, jours:335}, pauses_detail:[
  ...
  modes:{
    nv100:{
      ...
      pauses_detail:[
        ...
        { xp:40000, periode:"02/11/2022 -> 07/03/2026", mois:40, jours:1222 }
      ]
    }
  }
},
  ...
  modes:{
    nv100:{
      ...
      pauses_detail:[
        ...
        { xp:40000, periode:"28/10/2022 -> 06/04/2026", mois:41, jours:1256 }
      ]
    }
  }
},
  ...
  modes:{
    nv100:{
      ...
      pauses_detail:[
        ...
        { xp:40, periode:"03/2026 -> 06/2026", mois:3, jours:92 }
      ]
    }
  }
},
